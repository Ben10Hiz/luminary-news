...
export const stories: Story[] = [
  {
    ...
    dek: "Is a test that has nothing to do with learning to read worth the pain it causes to children?",
...
> Our school spent weeks prepping, doing practice tests, etc. Put all spelling tests on hold for about a month, at least.
>
...
> I'm about to the point of withdrawing permission for my son to take standardized tests and the school can just get over it. He wouldn't be on the honor roll with all A's and B's if he wasn't learning what he needs to be learning.
>
...
> They also, at our school anyway, are forced to take summer school after 2nd grade if they don't pass the IREAD at the end of the year. If they pass at the end of 2nd grade they don't have to take it in third, but if they fail it in third they get held back.
>
> Amber Curry · Parent · August 2025

> If the retention part has always been there, we were never told that. So I highly doubted it was an automatic hold back. Now it seems to be enforced.
>
> Jeremy Knudsen · Parent · August 2025

> The number of 'diagnostics' and computer testings my children do each school year is mind blowing.
>
> Ashley Meade Dembinski · Parent · August 2025

> I went to the IDOE website. It just wasn't as extensive as I had hoped. I was looking for an actual practice test but couldn't get anything like it to print.
>
> Venus Cannon · Grandparent · November 2025

> They can be held back for not passing a test, yet when a parent wants to hold them back in kindergarten or first grade they have to jump through hoops.
>
> Skylar Nusbaum · Parent · August 2025

> They allowed 2nd graders to take it last year as well as 3rd graders, to see if they could test out and not have to take it as a 3rd grader. My daughter passed it as a second grader, so she doesn't take it this year.
>
> Sarah Hebert · Parent · August 2025

> They are also testing them in second grade to see where each kid is, and if they pass in second they don't have to take the IREAD in third — just ILEARN.
>
...
> Could it be because there were such high stakes — mandatory retention — that schools ONLY focused on IREAD and nothing else?
>
...
> I believe the fear of retention and the implementation of the science of reading led to some of these gains.
>
> April Ann Marie Adams · Third grade teacher, 13 years · August 2025

> When I was in MTSS meetings about 2 years back, in anticipation of this law going into effect, many students that may have once been thought to benefit from being held back were being pushed into the next grade. It was thought that if they held someone back, then that person still failed the test, they would still be required to hold them a 2nd year.
>
> Esperanza Lindsey Monge · Educator · June 2026

> Two years ago when they touted the strong increase, they never shared that they removed the timing, which was a significant barrier for many kids. This year they added an additional testing opportunity, but are again not sharing that.
>
...
> I swear some of the passages are the same as they were 10 years ago. The only difference is they had to add more, because they are now giving at least 2 more opportunities to test — 2nd grade, and you can retake it twice in the summer window.
>
> Cara Davis Rothrock · Third grade teacher, 11 years, two districts · August 2025

> We did after school tutoring for months, and summer school for our kids at risk of not passing. Lots of time and energy.
>
> Heather Severns Shelley · Educator · August 2025

> The child is bored. Don't accept the results for his placement. Demand a human assessment after a month of regular human tutoring.
>
> Reita Bourget · Retired educator · November 2025

> No spelling tests. Kids moving onto 4th grade and cannot spell beginner words. Same with math — seeing kids in 3rd and 4th grade that can't subtract multiple-digit numbers.
>
...
> Students with IEPs still have to take these tests, as well as English Language Learners that have been in country for a short amount of time. They can apply for a good cause exemption for those students, but they have DRASTICALLY reduced the number of those that are allowed.
>
> Allison 'Goodwin' Smiley · Educator · August 2025

> I hated it for the kids when testing became the norm. I tried to make it as fun as I could. I wasn't a good test taker before I was a teacher, so I knew how it felt.
>
> Penny Watterson Cooper · Teacher · August 2025

> The law changed and good cause exemptions weren't allowed anymore. Before we could give a GCE to students with IEPs or students who are learning English.
>
> Erin Kathleen Hodel · Teacher · November 2025

> If your kids use these programs and are moved to a lower tier, you must demand a human assessment as well.
>
> Reita Bourget · Retired educator and tutor · November 2025

> IREAD 3 is an untimed assessment. Focus on reading passages and comprehension questions. There is a phonics section but comprehension is the bulk. You can find released items on the IDOE website.
>
> Tamara Mowery Gore · Teacher, replying to a grandmother in the comments · November 2025

> They did change it a little — it's no longer timed. For some, the time constraint would cause them not to pass.
>
...
> Literally, if they didn't pass they would have to take third grade over again. Teachers only focused on the IREAD.
>
...
> They had more chances to fail, but that doesn't fit the district narratives.
>
> April Diamond · Commenter · August 2025

> Standardized tests have their use, but they need to be their own lane, and a small one. Teaching to the test is garbage.
>
> Mark Andrew · Commenter · August 2025

> How 412 kids last couple years and 3,000 kids — it's just ridiculous. Boggles the mind.
>
...
> And they get to take it twice in second grade and three times in third grade. That helps the average.
>
